...
export default function Main() {
  return (
    <>
      <div className="select-none bg-gray-200 text-white my-8 sm:mt-12 sm:mb-2 lg:mt-16 lg:mb-4 px-4 sm:px-6 lg:px-20 flex justify-center items-center overflow-hidden">
